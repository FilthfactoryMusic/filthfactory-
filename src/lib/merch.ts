...
export const FACTORY_MERCH: MerchSku[] = [
  { id: "tee-black", name: "Factory tee", blurb: "Embroidered circle stamp. Classic factory shot. Print mock until stitch samples land.", pence: 2000, image: "/art/merch/tee.jpg?v=classic1", kind: "tee", color: "Black", swatch: "#111111" },
  { id: "hoodie-black", name: "Factory hoodie", blurb: "Embroidered chest stamp. Classic factory shot.", pence: 4800, image: "/art/merch/hoodie.jpg?v=classic1", kind: "hoodie", color: "Black", swatch: "#111111" },
  { id: "beanie-black", name: "Stamp beanie", blurb: "Embroidered cuff stamp.", pence: 1800, image: "/art/merch/beanie.jpg?v=classic1", kind: "beanie", color: "Black", swatch: "#111111" },
  { id: "snapback-black", name: "Stamp cap", blurb: "Embroidered front stamp.", pence: 2500, image: "/art/merch/snapback-black.jpg?v=classic1", kind: "snapback", color: "Black", swatch: "#111111" },
  { id: "keyring", name: "Stamp keyring", blurb: "Metal disc. The circle on your keys.", pence: 800, image: "/art/merch/keyring.jpg?v=classic1", kind: "keyring", color: "Steel", swatch: "#c4c4c0" },
];
