...
export const WORLD_DJS: Dj[] = [
  ...
  },
  {
    ...
    city: "London",
    citySlug: "london",
    photo: "/art/stations/life-fm.jpg",
    show: "Life FM",
    genres: ["UK Garage", "House"],
    followers: 12000,
    bio: "Old school house and garage. Official public desk.",
  },
  {
    id: "groove-london",
    name: "Groove London",
...
export const WORLD_LIVE: LiveShow[] = [
  ...
  room({
    ...
    city: "London",
    citySlug: "london",
    artwork: "/art/stations/life-fm-card.jpg",
    genres: ["UK Garage", "House"],
    engine: "ukg",
    listeners: 480,
    description: "Old school house and garage. Opens their official desk.",
    watchUrl: "https://lifefmtv.squarespace.com/",
    credit: "Watch via Life FM",
  }),
  room({
